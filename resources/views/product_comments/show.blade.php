                    ...
                    <div class="container">
                        <div class="row single-widget ">
                                <div class="col-md-12 pb-30  ">
                                    ...
                                    <span><h2>{{ $product_comment->name }}</h2></span>
                        ...
                        <div class="row single-widget ">
                              <div class="col-md-7 pb-30  ">
                                <img src="{{ $product_comment->image }}" class="" style="max-width: 23em;    height: 100%;    width: 100%;" />
                              </div>
                              <div class="col-md-5 " >
                                    <div class="row">
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-12 pb-30  ">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-12 col-xs-12">
                                            ...
                                            <h3><strong><b>{{ $product_comment->price }}</b></strong> руб. <span class="pull-right"><a href="" class="btn to_cart btn-success" style="background-color: #691cff; border-color: #691cff"> <i class="fa fa-cart-plus" aria-hidden="true"></i> В корзину</a></span> </h3>
 ...
 --}}
    ...
    <div id="myTabContent" class="tab-content">
      <div id="home" role="tabpanel" aria-labelledby="home-tab" class="tab-pane fade px-4 py-5 show active">
        {{ $product_comment->desc }}
      </div>
      <div id="profile" role="tabpanel" aria-labelledby="profile-tab" class="tab-pane fade px-4 py-5">
                                @php
                                    $a1 = explode("\n", $product_comment->attrs);
                                @endphp
