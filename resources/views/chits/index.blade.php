...
@section('content')
    <section class="content-header">
        <h1 class="pull-left"><b>Список:</b>  Комментарии на Главной</h1>
        <h1 class="pull-right">
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('chits.create') !!}"> <i class="fa fa-plus" aria-hidden="true"></i> Создать</a>
           <a class="btn btn-danger pull-right" style="margin-top: -10px;margin-bottom: 5px" href="/chits_destroy_all"> <i class="fa fa-trash" aria-hidden="true"></i> Очистить</a>
    ...
    <div class="content">
        ...
        @include('adminlte-templates::common.paginate', ['records' => $chits])
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="/chits/import" method="POST" >
              @csrf
