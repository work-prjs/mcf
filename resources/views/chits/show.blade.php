                    ...
                    <div class="container">
                        ...
                        <div class="row single-widget ">
                              <div class="col-md-7 pb-30  ">
                                <img src="{{ $chit->image }}" class="" style="max-width: 23em;    height: 100%;    width: 100%;" />
                              </div>
                              <div class="col-md-5 " >
                                    <div class="row">
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-12 pb-30  ">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-12 col-xs-12">
                                            ...
                                            <h3><strong><b>{{ $chit->price }}</b></strong> руб. <span class="pull-right"><a href="" class="btn to_cart btn-success" style="background-color: #691cff; border-color: #691cff"> <i class="fa fa-cart-plus" aria-hidden="true"></i> В корзину</a></span> </h3>
