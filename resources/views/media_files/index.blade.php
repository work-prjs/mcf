...
@section('content')
    <section class="content-header">
        <h1 class="pull-left"><b>Список:</b>  {{ __('Media File') }}</h1>
        <h1 class="pull-right">
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('mediaFiles.create') !!}"> <i class="fa fa-plus" aria-hidden="true"></i> Создать</a>
           <a class="btn btn-danger pull-right" style="margin-top: -10px;margin-bottom: 5px" href="/mediaFiles_destroy_all"> <i class="fa fa-trash" aria-hidden="true"></i> Очистить</a>
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                    @include('media_files.table')
            </div>
        </div>
        <div class="text-center">
        
        @include('adminlte-templates::common.paginate', ['records' => $mediaFiles])
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="/mediaFiles/import" method="POST" >
              @csrf
